        ...
        try {
          ...
          cartList.asMap().entries.forEach((element) {
            if (element.value.isPackage! == false) {
              ...
              if (element.value.serviceList?.selectedAdditionalServices !=
                ...
                for (var item
                  ...
                  if (item is Map<String, dynamic>) {
                    additionalServiceId.add(item['id']);
                  } else {
              ...
              log("element.value.serviceList!.type::${element.value.serviceList!.type}////$additionalServiceId}");
          ...
          var body = {
            ...
            "coupon": data != null
                ...
                : couponCtrl.text.isEmpty
                    ? null
                    : couponCtrl.text,
            "wallet_balance": userModel.wallet?.balance ?? null,
            "payment_method": "cash",
            "currency_code": "USD"
          };
        ...
        try {
          ...
          cartList.asMap().entries.forEach((element) {
            if (element.value.isPackage! == false) {
              ...
              log("element.value.serviceList!.type::${element.value.serviceList!.type}////$additionalServiceList}");
