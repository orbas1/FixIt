import 'package:fixit_provider/model/index.dart' hide Tax;
import 'package:fixit_provider/model/service_tax_model.dart' hide Tax;
...
class EditServiceModel {
  ...
  List<EditServiceModel>? relatedServices;
  List<Media>? media;
  ...
  EditServiceModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['related_services'] != null) {
      relatedServices = <EditServiceModel>[];
      json['related_services'].forEach((v) {
        relatedServices!.add(EditServiceModel.fromJson(v));
      });
    }
    if (json['media'] != null) {
      media = <Media>[];
